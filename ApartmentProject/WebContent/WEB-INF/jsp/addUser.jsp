...
<body>
	...
	<table>
		<tr>
			<td><a href="/ApartmentProject/user"><button type="button">Add User</button></a> <%-- 					<form method="GET" action="/ApartmentProject/user"commandName="user"> --%>
<!-- 					<input type="submit" value="Add User" /> --> 
<%-- 					</form> --%>
			</td>
			<td><a href="/ApartmentProject/showUser"><button type="button">Show User</button></a> <%-- 					<form method="POST" action="/ApartmentProject/showUser"commandName="showUser"> --%>
<!-- 					<input type="submit" value="Show User" /> --> 
<%-- 					</form> --%>
			</td>
			<td><a href="/ApartmentProject/showRoom"><button
						type="button">Show Room</button></a> <%-- 					<form method="POST" action="/ApartmentProject/showRoom"commandName="showRoom"> --%>
